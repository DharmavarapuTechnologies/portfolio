...
const Projects = (props: Props) => {
  ...
  return (
    <motion.div
      ...
      className='flex flex-col relative h-screen text-center md:text-left md:flex-col justify-evenly mx-auto items-center snap-center text-[#F2F3F4]'>
      <h3 className='absolute top-24 uppercase tracking-[20px] text-[#F2F3F4] text-2xl'>Projects</h3>

      <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20'>
        {projects.map((project, i) => (
          <div className='mt-10 w-screen flex-shrink-0 snap-center flex flex-col items-center justify-center h-screen'>
            <Card>
              <motion.img 
                initial={{
                  y: -100,
                ...
                viewport={{ once: true }}
                src={project.image} 
                className='w-full flex items-center justify-center h-[180px] border-10 shadow-[0 0 16px 2px rgba(0, 0, 0, 0.3)]'
              />
              <Tags></Tags>
              <Details>
